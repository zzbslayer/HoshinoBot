...
svtw = Service('pcr-arena-reminder-tw', enable_on_default=False, help_='背刺时间提醒（国服）', bundle='pcr订阅')
svjp = Service('pcr-arena-reminder-jp', enable_on_default=False, help_='背刺时间提醒（日服）', bundle='pcr订阅')
msg = '骑士君、准备好背刺了吗？'
